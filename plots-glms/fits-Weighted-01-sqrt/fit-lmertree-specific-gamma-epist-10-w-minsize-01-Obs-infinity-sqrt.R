...
## And we focus on sample size 4000, uniform sampling, and 10 genes.
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_10genes_gamma_epist_withFL_Inf_BBY",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_10genes_gamma_epist_withFL_Inf_NM",
                          lmer.control = lmerControl(optimizer = "Nelder_Mead")                          
                          , weights = TRUE,minsizef = 0.01)

print(warnings())

tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_10genes_gamma_epist_withFL_Inf_default"
                          , weights = TRUE,minsizef = 0.01)


print(warnings())

tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_10genes_gamma_epist_withFL_Inf_NLM",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_10genes_gamma_epist_withFL_Inf_LBF",
                          lmer.control = lmerControl(optimizer = "optimx",
