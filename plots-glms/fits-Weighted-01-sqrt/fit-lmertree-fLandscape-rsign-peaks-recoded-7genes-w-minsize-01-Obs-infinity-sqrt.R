...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fLandscape-rsign-peaks-recoded_7genes_Inf_BBY",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fLandscape-rsign-peaks-recoded_7genes_Inf_NM",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fLandscape-rsign-peaks-recoded_7genes_Inf_default"
                          , weights = TRUE,minsizef = 0.01)
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fLandscape-rsign-peaks-recoded_7genes_Inf_NLM",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fLandscape-rsign-peaks-recoded_7genes_Inf_LBF",
                          lmer.control = lmerControl(optimizer = "optimx",
