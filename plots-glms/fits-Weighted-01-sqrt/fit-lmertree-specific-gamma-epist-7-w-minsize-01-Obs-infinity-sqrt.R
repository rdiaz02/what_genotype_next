...
## And we focus on sample size 4000, uniform sampling, and 7 genes.
...
## Change name of typeLandscape and names of values
...
## Additional filters
localdata <- localdata[ (numGenes == 7) &
                        (sample_size == 4000) &
                        (detect == "uniform")
                     , ]
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_7genes_gamma_epist_withFL_Inf_BBY",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_7genes_gamma_epist_withFL_Inf_NM",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_7genes_gamma_epist_withFL_Inf_default"
                          , weights = TRUE,minsizef = 0.01)


print(warnings())

tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_7genes_gamma_epist_withFL_Inf_NLM",
...
tree_best_time_print_save("allFL", Inf, "lmertree_sqrt_W_Obs_minsize_01_fl_specific_7genes_gamma_epist_withFL_Inf_LBF",
                          lmer.control = lmerControl(optimizer = "optimx",
